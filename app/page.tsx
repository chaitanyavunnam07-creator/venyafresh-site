    ...
    <main className="w-full bg-[#0B1F2A] text-white selection:bg-sky-400/30 overflow-x-hidden scroll-smooth">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black border-t border-white/10">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <h2 className="text-6xl md:text-9xl font-black tracking-tighter uppercase mb-8 leading-none">MALPE <br /> <span className="text-white/80 font-black">SIGNATURE</span></h2>
          <Link href="/order">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black border-t border-white/10">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <h2 className="text-6xl md:text-9xl font-black tracking-tighter uppercase mb-8 text-white/40 leading-none">ANDAMAN <br /> <span className="text-white/20">RESERVE</span></h2>
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black border-t border-white/10">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <h2 className="text-6xl md:text-9xl font-black tracking-tighter uppercase mb-8 text-white/40 leading-none">RIVER <br /> <span className="text-white/20">CATCH</span></h2>
          <button className="px-12 py-4 border border-white/20 text-white/40 text-[10px] font-bold uppercase tracking-[0.4em] cursor-not-allowed rounded-full bg-black/20">
            Notify Me
          </button>
        </div>
