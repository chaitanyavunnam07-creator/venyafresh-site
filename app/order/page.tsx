      ...
      <main className="min-h-screen bg-[#0B1F2A] text-white selection:bg-sky-400/30 overflow-x-hidden">
        ...
        <div className="pt-32 pb-20 px-4 md:px-8 max-w-screen-xl mx-auto">
          <header className="mb-16 border-l-4 border-sky-400 pl-6 py-2 bg-white/5 backdrop-blur-md rounded-r-2xl">
            ...
            <p className="text-slate-300 uppercase tracking-[0.2em] text-[10px] font-bold leading-relaxed">Flash Frozen Within 120 Minutes of Catch • Zero Preservatives • Odor-Locked</p>
          </header>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((p) => (
              <div key={p.id} className="group relative bg-white/5 border border-white/10 rounded-3xl overflow-hidden hover:border-sky-400/40 transition-all duration-5
