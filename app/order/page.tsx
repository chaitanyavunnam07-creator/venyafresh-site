    ...
    <div className="min-h-screen bg-[#0B1F2A] text-white selection:bg-sky-400/30 overflow-x-hidden font-sans">
      ...
      <div className="pt-32 pb-20 px-4 md:px-8 max-w-screen-xl mx-auto">
        <header className="mb-16 border-l-4 border-sky-400 pl-6 py-2 bg-white/5 backdrop-blur-md rounded-r-2xl">
          <h1 className="text-3xl md:text-5xl font-black tracking-tighter uppercase mb-2">The <span className="text-sky-400 italic font-serif">Sub-Zero</span> Catalog</h1>
          <p className="text-slate-300 uppercase tracking-[0.2em] text-[10px] font-bold">Flash Frozen Within 120 Minutes of Catch • Zero Preservatives</p>
        </header>
          ...
          {PRODUCTS_LIST.map((item) => (
            <div key={item.id} className="group relative bg-white/5 border border-white/10 rounded-3xl overflow-hidden hover:border-sky-400/40 transition-all duration-500 shadow-2xl">
              <div className="aspect-[4/5] overflow-hidden relative">
                ...
                <div className="absolute top-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 text-white text-[8px] font-black uppercase px-3 py-1.5 rounded-full">{item.tag}</div>
              </div>
              <div className="p-8">
